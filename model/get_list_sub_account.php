...
function get_list_sub_account($dbconn, $parent_account = NULL) {
	...
	if ($parent_account != NULL) {
		...
		$strsql = "SELECT chart_of_account_sub_account, chart_of_account_parent_account, " . 
	...
	$stmt->bind_result($coa_sub_acct, $coa_parent_acct, $coa_acct_no, $coa_group, $coa_type);
	
	while($stmt->fetch()) {
		$resultarray[] = array('coa_sub_account' => $coa_sub_acct,
